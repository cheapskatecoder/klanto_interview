"""
Django settings for klantointerview project.
...
SECRET_KEY = '7s6eoi03h)i##$$q!7ngd#_ypcg*_u)s-4edk0ri(_-*z1!4n@'
...
ROOT_URLCONF = 'klantointerview.urls'
...
WSGI_APPLICATION = 'klantointerview.wsgi.application'
